...
(function () {
        ...
        function C(a, b) {
            var c = a % this.DB, d = this.DB - c, e = (1 << d) - 1, f = Math.floor(a / this.DB),
...
function encrypt(pubkey, servertime, nonce, pwd) {
    var f = new sinaSSOEncoder.RSAKey;
    f.setPublic(pubkey, "10001");
    return f.encrypt([servertime, nonce].join("\t") + "\n" + pwd);
}
...
function A() {
    return "undefined" != "object" && "function" == "function" ? crypto.getRandomValues(C) : "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues ? msCrypto.getRandomValues(C) : C
}
...
function traceparent(){
    ...
    var traceId = traceId();
    var o = parentId();
    return e + "-" + traceId + "-" + o + "-" + n
    //  return e + "-" + t.traceId + "-" + o + "-" + i
}